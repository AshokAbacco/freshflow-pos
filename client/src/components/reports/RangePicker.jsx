  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <Segmented
        ...
        options={PRESETS}
      />
      <div className="flex items-center gap-1.5 rounded-full bg-white px-2 py-1 ring-1 ring-black/10 focus-within:ring-brand">
        <input
          type="date"
          ...
          max={range.to}
          onChange={(e) =>
            e.target.value && onChange({ ...range, from: e.target.value })
          }
        ...
        <input
          ...
          min={range.from}
          onChange={(e) =>
            e.target.value && onChange({ ...range, to: e.target.value })
          }
          aria-label="To date"
        />
      </div>
